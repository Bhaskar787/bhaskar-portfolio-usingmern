      ...
      ({ closeToast }) => (
        <div className="bg-slate-900 border border-slate-700 p-4 sm:p-5 rounded-xl shadow-xl w-full max-w-sm mx-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={closeToast}
              className="bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 rounded-lg transition-colors text-sm sm:text-base"
            >
              Cancel
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            type="submit"
            className="w-full mt-6 bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-3 sm:py-3.5 rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all font-semibold shadow-lg shadow-purple-900/50 flex items-center justify-center gap-2 text-sm sm:text-base"
          >
            <FiPlus size={18} className="sm:text-lg" />
            {editingId ? "Update Project" : "Add Project"}
          </motion.button>
        </motion.form>

        {/* Projects List - Card View for Mobile, Table for Desktop */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    ...
                    <div className="flex gap-2 mt-4">
                      <button
                        ...
                        className="flex-1 bg-yellow-500/20 hover:bg-yellow-500/30 text-yellow-400 px-3 py-2 rounded-lg transition-colors text-sm flex items-center justify-center gap-2"
                      >
                        <FiEdit2 size={16} />
                        Edit
                      </button>
                      <button
                        ...
                        className="flex-1 bg-red-500/20 hover:bg-red-500/30 text-red-400 px-3 py-2 rounded-lg transition-colors text-sm flex items-center justify-center gap-2"
                      >
                        <FiTrash2 size={16} />
                        Delete
                      </button>
                      ...
                      >
                        ...
                        <td className="p-4">
                          <div className="flex gap-2 justify-center">
                            <button
                              onClick={() => editProject(project)}
                              className="bg-yellow-500/20 hover:bg-yellow-500/30 text-yellow-400 px-4 py-2 rounded-lg transition-colors flex items-center gap-2 text-sm"
                            >
                              <FiEdit2 size={16} />
                              Edit
                            </button>
                            <button
                              onClick={() => confirmDelete(project._id)}
                              className="bg-red-500/20 hover:bg-red-500/30 text-red-400 px-4 py-2 rounded-lg transition-colors flex items-center gap-2 text-sm"
                            >
                              <FiTrash2 size={16} />
                              Delete
                            </button>
