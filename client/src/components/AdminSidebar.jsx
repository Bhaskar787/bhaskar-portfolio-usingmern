...
export default function AdminSidebar() {
  ...
  return (
    <>
      {/* Mobile Menu Toggle Button - Hide on scroll down */}
      <AnimatePresence>
        {showMenuButton && (
          <motion.button
      ...
      {/* Sidebar - Mobile: Hidden when closed, takes space when open */}
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            initial={{ x: "-100%" }}
            ...
            className="fixed top-0 left-0 w-64 bg-slate-950 text-slate-200 min-h-screen p-5 border-r border-slate-800 relative z-50 md:static md:translate-x-0"
          >
